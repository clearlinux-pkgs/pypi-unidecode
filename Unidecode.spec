...
Source0  : https://files.pythonhosted.org/packages/df/11/60a304d3bfa84173f0bfb64f81e26ac5b0bff4c657d8fb6c26ff89ab8240/Unidecode-1.3.1.tar.gz
...
%prep
%setup -q -n Unidecode-1.3.1
cd %{_builddir}/Unidecode-1.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631248880
...
cp %{_builddir}/Unidecode-1.3.1/LICENSE %{buildroot}/usr/share/package-licenses/Unidecode/4cc77b90af91e615a64ae04893fdffa7939db84c
