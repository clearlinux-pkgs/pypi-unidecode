...
Version  : 1.3.0
Release  : 24
URL      : https://files.pythonhosted.org/packages/51/8e/1f9811ff26c04ff16e406e2cd7e5fc9b1e21ac80fcbaa29f38077733492b/Unidecode-1.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/51/8e/1f9811ff26c04ff16e406e2cd7e5fc9b1e21ac80fcbaa29f38077733492b/Unidecode-1.3.0.tar.gz
...
%prep
%setup -q -n Unidecode-1.3.0
cd %{_builddir}/Unidecode-1.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631216820
...
cp %{_builddir}/Unidecode-1.3.0/LICENSE %{buildroot}/usr/share/package-licenses/Unidecode/4cc77b90af91e615a64ae04893fdffa7939db84c
