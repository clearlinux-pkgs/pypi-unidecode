...
Source0  : https://files.pythonhosted.org/packages/0b/25/37c77fc07821cd06592df3f18281f5e716bc891abd6822ddb9ff941f821e/Unidecode-1.3.6.tar.gz
...
%prep
%setup -q -n Unidecode-1.3.6
cd %{_builddir}/Unidecode-1.3.6
pushd ..
cp -a Unidecode-1.3.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664556947
