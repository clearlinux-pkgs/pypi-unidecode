...
Version  : 1.3.5
Release  : 41
URL      : https://files.pythonhosted.org/packages/c1/b4/6c2f0e3198ebab1d0cc692490d993404f18b0d20bd6640def4f713cb542d/Unidecode-1.3.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/c1/b4/6c2f0e3198ebab1d0cc692490d993404f18b0d20bd6640def4f713cb542d/Unidecode-1.3.5.tar.gz
...
%prep
%setup -q -n Unidecode-1.3.5
cd %{_builddir}/Unidecode-1.3.5
pushd ..
cp -a Unidecode-1.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664376552
