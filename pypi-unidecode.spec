...
Source0  : https://files.pythonhosted.org/packages/66/9e/e335087e5d7487f032aeb08e21d5c3068fd1f0862f3936748ca2e2949bcc/Unidecode-1.3.3.tar.gz
...
%prep
%setup -q -n Unidecode-1.3.3
cd %{_builddir}/Unidecode-1.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645304728
...
cp %{_builddir}/Unidecode-1.3.3/LICENSE %{buildroot}/usr/share/package-licenses/pypi-unidecode/4cc77b90af91e615a64ae04893fdffa7939db84c
