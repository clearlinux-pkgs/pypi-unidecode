...
Source0  : https://files.pythonhosted.org/packages/41/a6/93288318cfae2fa0ca978dfe6bb94b22b7e9a9e98b6149a4af00b1e76ee8/Unidecode-1.3.2.tar.gz
...
%prep
%setup -q -n Unidecode-1.3.2
cd %{_builddir}/Unidecode-1.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641599022
...
cp %{_builddir}/Unidecode-1.3.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-unidecode/4cc77b90af91e615a64ae04893fdffa7939db84c
